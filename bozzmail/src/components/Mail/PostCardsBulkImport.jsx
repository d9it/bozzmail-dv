...
const PostCardsBulkImport = ({ onOpenChange }) => {
    ...
    return (
        <>
            ...
            <button className='table-dropdown-title text-left border border-transparent cursor-pointer' onClick={handleModalOpen}>Postcards</button>
            ...
            <Modal isOpen={modalOpen} onClose={handleModalClose}>
                ...
                <div className="flex flex-col gap-12 sm:gap-20">
                    <div className="space-y-4">
                        <p className="text-xl sm:text-25px font-semibold text-main-text pr-40">Postcards Bulk Import</p>
                    ...
                    <div className="flex justify-end items-center gap-10 flex-wrap">
                        ...
                        <NavLink to={"/import-postcards"} className='flex items-center justify-between gap-8 button-icon'>
                            <CgEye className="text-base text-white flex-none" />
                            <span> Continue to Preview</span>
                        </NavLink>

                        {/* disable button */}
                        {/* <NavLink to={"/import-postcards"} className='flex items-center justify-between gap-8 disable-button-icon'>
                            <CgEye className="text-base text-white flex-none" />
                            <span> Continue to Preview</span>
                        </NavLink> */}
                    </div>
...
export default PostCardsBulkImport;