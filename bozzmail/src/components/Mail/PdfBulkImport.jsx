...
const PdfBulkImport = ({ onOpenChange }) => {
    ...
    return (
        <>
            ...
            <button className='table-dropdown-title text-left border border-transparent cursor-pointer' onClick={handleModalOpen}>PDFs</button>
            ...
            <Modal isOpen={modalOpen} onClose={handleModalClose}>
                ...
                <div className="flex flex-col gap-12 sm:gap-20">
                    <div className="space-y-4">
                        <p className="text-xl sm:text-25px font-semibold text-main-text pr-40">PDFs Bulk Import</p>
                        <p className="font-medium text-13px sm:text-sm text-secondary-text">Upload a CSV, XLSX, or JSON file with your mail data</p>
                    </div>

                    {/* Spreadsheet */}
                    {/* note for developer: make this dropdown bu default open */}
                    <div ref={dropdown1.ref} className="relative">

                        <button className='flex justify-between items-center w-full focus:border-none cursor-pointer' onClick={dropdown1.toggle} ref={dropdown1.triggerRef}>
                            <p className="text-main-text font-semibold text-xl">1. Spreadsheet</p>
                            <IoChevronDown className={`text-base transition-transform duration-300 text-main-text ${dropdown1.isOpen ? 'rotate-180' : 'rotate-0'}`} />
                        </button>

                        {dropdown1.isOpen && (
                            <div className="flex flex-col pt-12 sm:pt-20 gap-12 sm:gap-20">
                    ...
                    <div ref={dropdown2.ref} className="relative">
                        ...
                        <button className='flex justify-between items-center w-full focus:border-none cursor-pointer' onClick={dropdown2.toggle} ref={dropdown2.triggerRef}>
                            <p className="text-main-text font-semibold text-xl">2. PDFs</p>
                            ...
                            <div className="flex flex-col pt-12 sm:pt-20 gap-12 sm:gap-20">
                                <div className='flex justify-start gap-8 flex-col w-full relative'>
                                    ...
                                    <label htmlFor="file" className="w-full border border-Outlines border-dashed rounded-lg py-48 sm:px-120 px-40 cursor-pointer flex flex-col gap-12 items-center justify-center text-center">
                                        ...
                                        <p className="font-medium text-secondary-text text-13px">ZIP-archive with PDFs, max 100MB</p>
                                    </label>
                                </div>
                                ...
                                <div className="border border-upload-green-border bg-upload-green p-20 rounded-lg flex justify-between items-center flex-wrap gap-8">
                                    <div className="flex gap-11 items-center justify-start">
                                        <div className="p-8 rounded-md bg-card-light-green flex-none">
                                            <GrDocumentZip className="text-dark-green text-lg flex-none" />
                                        </div>
                                        <div className="font-medium">
                                            <p className="text-sm text-main-text">pdfs-for-import.zip</p>
                                            <p className="text-secondary-text text-xs">5 elements</p>
                                        </div>
                                    </div>
                                    <div className='flex gap-10 justify-end items-center'>
                                ...
                                <div className="warning-message">
                                    <PiWarningCircle className='text-secondary-text text-17px stroke-3 flex-none' />
                                    <p>File names must match the 'template_name' column in your spreadsheet</p>
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex justify-end items-center gap-10 flex-wrap">
                        ...
                        {/* for disable button */}
                        {/* <NavLink to={"/import-pdf"} className='flex items-center justify-between gap-8 disable-button-icon'>
                            <CgEye className="text-base text-white flex-none" />
                            <span> Continue to Preview</span>
                        </NavLink> */}

                        <NavLink to={"/import-pdf"} className='flex items-center justify-between gap-8 button-icon'>
                            <CgEye className="text-base text-white flex-none" />
                            <span> Continue to Preview</span>
                        </NavLink>
                    </div>
