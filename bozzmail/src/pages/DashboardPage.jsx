  ...
  return (
    <>
      ...
      */}
      ...
      <div className='py-20 sm:py-30 pr-15 sm:pr-30 bg-white rounded-15px sm:rounded-20px'>
        ...
        <div className='flex gap-15 sm:gap-25 items-center justify-start'>
          ...
          <div className='flex gap-5 sm:gap-10'>
            <img src="asset/icons/dashboard-big.svg" alt="icon" className='hidden sm:block' />
            <img src="asset/icons/heading_label.svg" alt="icon" className='block sm:hidden' />
            <h1 className='font-semibold text-22px sm:text-25px text-main-text'>Welcome back Rui!</h1>
          </div>
        </div>
      ...
      <div className='py-20 sm:py-30 px-15 sm:px-30 bg-white rounded-15px sm:rounded-20px space-y-20'>

        {/* dropdown */}
        <div className='flex justify-between'>
          <h2 className='font-semibold  text-17px sm:text-xl text-main-text'>Active Pickup Requests <span>(5)</span></h2>
          <img src="asset/icons/icon-park-outline_drag.svg" alt="icon" />
        </div>
