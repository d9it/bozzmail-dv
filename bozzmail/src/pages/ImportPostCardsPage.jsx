...
import ImportPostCardsReviewTab from './import-postcards-tabs/ImportPostCardsReviewTab';
import ImportPostCardsPaymentTab from './import-postcards-tabs/ImportPostCardsPaymentTab';
import ImportPostCardsCompleteTab from './import-postcards-tabs/ImportPostCardsCompleteTab';
import { GoPlus } from "react-icons/go";


const ImportPostCardsPage = () => {
  ...
  return (
    <>
      ...
      <div className='py-20 sm:py-30 px-15 sm:px-30 bg-white rounded-15px sm:rounded-20px'>
        ...
        <div className='flex justify-between items-center flex-wrap gap-10 w-full'>
          <NavLink to={"/print-mail"} className='flex items-center justify-start gap-10'>
            ...
            <h2 className='font-semibold text-17px sm:text-xl text-main-text'>Import Postcards</h2>
          </NavLink>
      ...
      {/* tab content */}
      {activeTab === "review" && <ImportPostCardsReviewTab />}
      {activeTab === "payment" && <ImportPostCardsPaymentTab />}
      {activeTab === "complete" && <ImportPostCardsCompleteTab />}
...
export default ImportPostCardsPage
