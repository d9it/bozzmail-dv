...
import ImportReviewTab from './import-label-tabs/ImportReviewTab';
import ImportPaymentTab from './import-label-tabs/ImportPaymentTab';
import ImportCompleteTab from './import-label-tabs/ImportCompleteTab';
import { GoPlus } from "react-icons/go";


const ImportLabelPage = () => {
  ...
  return (
    <>
      ...
      <div className='py-20 sm:py-30 px-15 sm:px-30 bg-white rounded-15px sm:rounded-20px'>
        ...
        <div className='flex justify-between items-center flex-wrap gap-10 w-full'>
          <NavLink to={"/shipping-labels"} className='flex items-center justify-start gap-10'>
            ...
            <h2 className='font-semibold text-17px sm:text-xl text-main-text'>Import Labels</h2>
          </NavLink>
      ...
      {/* tab content */}
      {activeTab === "review" && <ImportReviewTab />}
      {activeTab === "payment" && <ImportPaymentTab />}
      {activeTab === "complete" && <ImportCompleteTab />}
...
export default ImportLabelPage
